...
const error: DeepPartial<Translation["error"]> = {
    ...
    connectionRetry: {
        unableConnect: "تعذر الfاتصال بـ flavortown. يرجى التأكد من أنك متصل بالإنترنت.", // Unable to connect to flavortown. Please ensure you are connected to the internet.
    },
    errorDialog: {
        title: "خطأ 😱", // Error 😱
